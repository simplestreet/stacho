...
//exit();
	...
	//全ユーザー情報更新
	$url = "https://api.instagram.com/v1/users/".$_SESSION['user']['instagram_user_id']."/?access_token=".$_SESSION['user']['instagram_access_token'];
	...
	if( $stmt->rowCount() > 0 ){
		...
		$url = "https://api.instagram.com/v1/users/".$_SESSION['user']['instagram_user_id']."/media/recent/?access_token=".$_SESSION['user']['instagram_access_token']."&min_id=".$result[0]["image_id"];
	} else {
		$url = "https://api.instagram.com/v1/users/".$_SESSION['user']['instagram_user_id']."/media/recent/?access_token=".$_SESSION['user']['instagram_access_token'];
	}
